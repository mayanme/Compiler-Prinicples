...
%macro SET_CDR 2
	mov qword [%1+TYPE_SIZE+WORD_SIZE], %2	
%endmacro
...
%define NUM_OF_ARGS_WITH_RSP qword [rsp+2*WORD_SIZE]
%define PVAR_WITH_RSP(n) qword [rsp+(3+n)*WORD_SIZE]

%define NUM_OF_ARGS qword [rbp+3*WORD_SIZE]
